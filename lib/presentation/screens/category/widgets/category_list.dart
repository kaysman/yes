    ...
    return SingleChildScrollView(
      child: KExpansionPanel.ExpansionPanelList(
        ...
        expansionCallback: (panelIndex, isExpanded) => setState(() {
          widget.category![panelIndex].isSelected = !isExpanded;
        }),
            ...
            .map(
              (e) => KExpansionPanel.ExpansionPanel(
                ...
                headerBuilder: (context, isExpanded) =>
                    _CategoryListSubCategory(data: e, isExpanded: e.isSelected),
                      ...
                      Container(
                        child: Row(
                          ...
                          children: [
                            ...
                            if (widget.data.subcategories != null &&
                                widget.data.subcategories!.isNotEmpty)
                              AnimatedRotation(
                                turns: widget.data.isSelected
                                    ? turns - 4.0 / 8.0
                                    : turns,
          ...
          child: ListTile(
            onTap: () {
              Navigator.of(context).pushNamed(ProductsScreen.routeName,
                  arguments: {
                    'filter': FilterForProductDTO(category_id: e.id)
                  });
            },
